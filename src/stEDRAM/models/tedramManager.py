...
class tEDRAM_TF:
    ...
    def create_tedram_model(self, learning_rate: float = 0.0001, n_steps: int = 10, glimpse_size: Tuple[int, int] = (26, 26), coarse_size: Tuple[int, int] = (12, 12),
        ...
        if self.input_shape_[1] == 120:  # 10 x 120 x 160 x 1
            self.model_ = tedram_model(input_shape=self.input_shape_, learning_rate=learning_rate, steps=n_steps, glimpse_size=glimpse_size, coarse_size=coarse_size, n_filters=n_filters,
        ...
        elif self.input_shape_[1] == 56:  # 10 x 56 x 120 x 160 x 1
            self.model_ = tedram_model_56imgs(input_shape=self.input_shape_, learning_rate=learning_rate, steps=n_steps, glimpse_size=glimpse_size, coarse_size=coarse_size, n_filters=n_filters,
        ...
        elif self.input_shape_[1] == 7: # 10 x 7 x 8 x 120 x 160 x 1
            self.model_ = tedram_model_56imgs(input_shape=self.input_shape_, learning_rate=learning_rate, steps=n_steps, glimpse_size=glimpse_size, coarse_size=coarse_size,
    ...
    def create_one_output_model(self, learning_rate: float = 0.0001, n_steps: int = 10, glimpse_size: Tuple[int, int] = (26, 26), coarse_size: Tuple[int, int] = (12, 12),
        ...
        self.model_ = tedram_op_model(input_shape=self.input_shape_, learning_rate=learning_rate, steps=n_steps, glimpse_size=glimpse_size, coarse_size=coarse_size, n_filters=n_filters,
