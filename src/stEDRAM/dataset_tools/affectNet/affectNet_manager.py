...
filename = "../src/training_dataset/binocular_image_data.h5"
...
with h5py.File("/scratch/gucr/tEDRAM2/training_dataset/AffectNet_train_data_keras.h5", "w") as w:
    w.create_dataset("emotions", data=features, compression='gzip', compression_opts=9)
    print("...dataset saved")

with open("/scratch/gucr/tEDRAM2/training_dataset/emotions_labels.txt", "wb") as d:
