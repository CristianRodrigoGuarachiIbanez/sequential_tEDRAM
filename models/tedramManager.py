...
class tEDRAM_TF:
    ...
    def create_tedram_model(self,
                               learning_rate: float = 0.0001, n_steps: int = 3, glimpse_size: Tuple[int, int] = (26, 26), coarse_size: Tuple[int, int] = (12, 12),
                               n_filters: int = 128, filter_sizes: Tuple[int, int] = (3, 5), n_features: int = 1024, RNN_size_1: int = 512, RNN_size_2: int = 512,
                               n_classes: int = 4, output_mode: int = 0, use_init_matrix: int = True, emission_bias: int = 1, clip_value: int = 1, unique_emission: int = False,
